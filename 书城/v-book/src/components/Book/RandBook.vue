    ...
    <div class="chapter-list" v-show="isShowChapter" v-scroll="onScroll">
      <div class="chapter-contents">
        ...
        <v-touch tag="span" class="chapter-sort" @tap="descSort">
          <img src="../../assets/image/down.svg" v-if="!chapterDescSort">
          <img src="../../assets/image/up.svg" v-else>
        </v-touch>
      </div>
...
<script>
  ...
  export default {
    ...
    // http://chapterup.zhuishushenqi.com/chapter/5d28000153b30a1222c6ae87?cv=1562902529500
    methods: {
      getBookChapterContent () {
        ...
        api.getBookChapterContent({
          link:this.bookChapter.chapters[lastChapter].link
        }).then(response => {
          console.log(response);
          /**
