        ...
        <div class="conter">
          <div class="conter_left">
            ...
            <ul class="thumbnail-list">
              <li class="thumbnail-item" v-for="(item,index) in thumbnails" :key="index" @mouseover="toggleActor(index)">
          ...
          <div class="right">
            ...
            <div class="banner-quantity">
              <input class="ipt-quantity" v-model="quantity" type="number" min=1>
            </div>
    ...
    export default {
      ...
      methods:{
       ...
       computed : {
         ...
         actorC(){
           return this.item.images[this.Imgindex];
         }
       }
    }
</script>
